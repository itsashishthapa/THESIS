...
In practical operation, the controller also has to react to external signals such as electricity prices, renewable generation, production demand, and ambient conditions. Since these signals change over time, fixed rule-based strategies can become inefficient, and the operation can be formulated as a finite-horizon decision problem with time-varying boundary conditions \cite{pilling2025rl}. This motivates two formulations of the same control task: constrained finite-horizon optimization and reinforcement learning.
